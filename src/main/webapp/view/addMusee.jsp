...
<body>
				...
				<s:else>
					<div class="btn-group pull-right">
						...
						<a class="btn btn-alert btn-danger" href="${linkListMusees }"
							role="button"><span class="glyphicon glyphicon-new-window"></span>Front Office</a> <a
	...
	<div class="container">
		<h2 class="sub-header">Formulaire d'ajout d'un nouveau musée</h2>
		<s:form method="post" enctype="multipart/form-data" action="saveAdd"
			acceptcharset="UTF-8" cssClass="well">
			<fieldset>
				<div class="form-group">
